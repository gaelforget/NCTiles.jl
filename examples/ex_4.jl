...
# Define Grid and get Grid variables
...
# Go through list of fields and write each to a set of tiled files
fldidx = 1:106
for fidx in fldidx
    @time begin
